...
const ReturnTable = ({ data, onKembalikan }) => {
  return (
          ...
          {data.map((item) => (
            ...
            >
              ...
              <td className="py-3 px-3">
                <button
                  className="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 text-sm hover:shadow transition-all hover:scale-105 cursor-pointer"
                  onClick={() => onKembalikan && onKembalikan(item)}
                >
                  Kembalikan
                </button>
              </td>
